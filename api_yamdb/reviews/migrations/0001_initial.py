    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, 'Оценка от 1 до 10'), django.core.validators.MaxValueValidator(10, 'Оценка от 1 до 10')], verbose_name='Оценка')),
